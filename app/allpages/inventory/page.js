...
import { FaBoxOpen, FaBox, FaDollarSign, FaPhoneAlt, FaSearch, FaTag, FaTags, FaPhone, FaIdCard, FaUsers } from "react-icons/fa";
...
const Inventory = () => {
    ...
    const [lucrativeModalFailBlank, setLucrativeModalFailBlank] = useState(false);
    const [lucrativeModalFailBlank00, setLucrativeModalFailBlank00] = useState(false);


    const lucrativeFailBlankFun = () => {
        setLucrativeModalFailBlank(true);
        setTimeout(() => setLucrativeModalFailBlank(false), 1500);
    };

    const lucrativeFailBlankFun00 = () => {
        setLucrativeModalFailBlank00(true);
        setTimeout(() => setLucrativeModalFailBlank00(false), 1500);
    };
    ...
    const handleManualSubmit = () => {
        console.log("Manual stock submitted:", itemStock);

        // your manual logic here
    };

    const getLucrativeDetails = () => {
        let changes = [];

        const currentStock = Number(oldItem.Stock || 0);
        const lucrativeQty = Number(lucrative);
        const newStock = currentStock - lucrativeQty;

        if (lucrativeQty > 0) {
            changes.push(
                `Lucrative issued: ${lucrativeQty} "${oldItem.Name}" by ${ticketName}`
            );
        }
    ...
    const handleLucrativeApprove = async () => {

        if (!Id) return;

        if (!ticketName || lucrative <= 0) {
            lucrativeFailBlankFun()
            return;
        }
        ...
        try {
            ...
            if (currentStock < lucrativeQty) {
                lucrativeFailBlankFun00()
                return;
            }

            const newStock = currentStock - lucrativeQty;
            const changes = getLucrativeDetails();
            // 1️⃣ UPDATE ITEM STOCK
            const itemRef = ref(db, `web/pos/${Id}/items/${itemEditID}`);
            ...
            // 2️⃣ SAVE LUCRATIVE RECORD
            const lucrativeRef = ref(db, `web/pos/${Id}/lucrative`);
            const newLucrative = push(lucrativeRef);

            await set(newLucrative, {
                itemId: itemEditID,
                itemName: oldItem.Name,
                quantity: lucrativeQty,
            ...
            console.log("Lucrative approved successfully");
            ...
            itemModalFunStock();
            editItemFailFun();
            console.log("Lucrative failed", error);

        }
    };

    const [lucrative, setLucrative] = useState("");
    const [ticketName, setTicketName] = useState("");     // Full Name
    const [phoneNumber, setPhoneNumber] = useState("");   // Phone Number
    const [idNumber, setIdNumber] = useState("");         // ID / Passport
    const [guestCount, setGuestCount] = useState("");      // Number of Guests
    ...
    return (
        <div className={`min-h-screen flex flex-col 
          ...
          ${theme === "Dark" ? "text-white" : "text-blue-700"}`} />
                ...
                {/* Items Management */}
                <section className="w-full lg:w-3/4 sm:h-auto h-screen flex flex-col rounded-xl overflow-y-auto">
                        ...
                        <div className="flex w-full justify-evenly sm:justify-start">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`text-xs sm:text-sm px-4 sm:py-2 py-1 rounded-lg mx-2 ${theme === "Dark"
                                        ? "text-white bg-blue-800 hover:bg-blue-600"
                                        : "bg-blue-600 text-white hover:bg-blue-800"
                                        }`}
                                >
...
${adjustMode === "manual"
                            ...
                            <button
                                onClick={() => setAdjustMode("lucrative")}
                                className={`px-3 py-2 rounded-lg text-xs 
${adjustMode === "lucrative"
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-4 gap-3 mt-2">
                                    ...
                                    <div className="col-span-1 space-y-1">
                                        ...
                                        <div className="relative">
                                            <div className="absolute left-3 top-1/2 -translate-y-1/2 text-black text-sm">
                                                {stockType === "na" ? <FaBan /> : <FaHashtag />}
                                            </div>

                                            <select
                                                className="w-full p-3 border border-gray-300 rounded pl-9 shadow-md text-sm"
                                                value={stockType}
                                                onChange={(e) => {
                                                    const value = e.target.value;
                                                    setStockType(value);
...
${stockType === "na" ? "bg-gray-100 cursor-not-allowed" : ""}`}
                                                value={stockType === "na" ? "" : itemStock}
                                                onChange={(e) => setItemStock(e.target.value)}
                                            />
                            ...
                            <div className="mt-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        <input
                                            ...
                                            className="w-full p-3 border border-gray-300 rounded pl-10 shadow-md text-sm"
                                            value={lucrative}
                                            onChange={(e) => setLucrative(Number(e.target.value))}
                                        />
                                        <FaBoxOpen className="absolute left-3 top-1/2 -translate-y-1/2 text-black" />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        />
                                        <FaIdCard className="absolute left-3 top-1/2 -translate-y-1/2 text-black" />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        />
                                        <FaUsers className="absolute left-3 top-1/2 -translate-y-1/2 text-black" />
                                    </div>
                                </div>
    ...
    ${adjustMode === "lucrative"
                            ...
                            <button
                                className={`${theme === "Dark"
                                    ? "bg-red-800 hover:bg-red-600"
                                    : "bg-red-600 hover:bg-red-800"}
text-white px-4 py-2 rounded text-xs sm:text-base`}
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 z-50">
                    <div className={` p-6 rounded-xl 
                     ...
                     ${theme === "Dark"
                        ...
                        <p>The Order was NOT approved</p>
                    </div>
                </div>
            )}
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80">
                    <div className={` p-6 rounded-xl 
                     ...
                     ${theme === "Dark"
                        ...
                        <p>Lucrative Quantity/ Full Name Empty</p>
                    </div>
                </div>
            )}
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80">
                    <div className={` p-6 rounded-xl 
                     ...
                     ${theme === "Dark"
                        ...
                        <p>Lucrative Quantity can N0T  exced Stock</p>
                    </div>
                </div>
            )}
