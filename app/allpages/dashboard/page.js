...
const Dashboard = () => {
  ...
  return (
    ...
    `}</style>
            ...
            {/* Items */}
            <section className="w-full md:w-1/2 p-4 rounded-lg h-screen overflow-y-auto">
  ...
  `}
      ...
      {receiptModal && (
        <div className="w-full z-50 flex items-center justify-center bg-black bg-opacity-10 overflow-y-auto">
    ...
    ${paymentError ? "border-red-500 ring-red-300" : "border-gray-300 focus:ring-[#303133]"}`}
        ...
        */}
              ...
              <button
                className={`py-2 px-3  text-xs sm:text-sm md:py-2 md:px-4 md:text-base  rounded
      ${theme === "Dark"
                    ? "text-white bg-blue-800 hover:bg-blue-600"
                    : "bg-blue-600 text-white hover:bg-blue-800 shadow-lg"
                  }`}
