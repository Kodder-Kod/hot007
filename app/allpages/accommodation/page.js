...
import { FaHotel, FaUser, FaTerminal, FaClock, FaBox, FaList, FaFile, FaEject, FaProductHunt, FaBoxOpen, FaExpand, FaFolder, FaTags, FaUsers, FaShoppingCart, FaChartLine, FaBed, FaCheckCircle, FaCalendarCheck, FaTools, FaUserTag, FaUserAlt, FaDollarSign, FaHashtag, FaPhone, FaIdCard, FaMoneyBillWave, FaCalendarAlt } from "react-icons/fa";
      ...
      `}
              ...
              {(!filteredItems || filteredItems.length === 0) && (
                <div className="flex flex-col items-center justify-center py-20 w-full overflow-hidden">
                  ...
                  {/* Accommodation Branding Animation */}
                  <div className="relative mb-10">
                    {/* Background "Aura" - slowly expands and contracts */}
                    <div className={`absolute inset-0 scale-150 blur-[50px] opacity-20 animate-[pulse_4s_ease-in-out_infinite] 
        ${theme === "Dark" ? "bg-blue-400" : "bg-blue-600"}`}></div>

                    {/* Main Icon - Floating vertically */}
                    <div className="relative z-10 animate-[float_3s_ease-in-out_infinite]">
                      <FaHotel className={`text-7xl transition-all duration-500 hover:scale-110 
          ${theme === "Dark" ? "text-white" : "text-blue-700"}`} />
                  ...
                  <div className="text-center px-4">
                    <h1 className={`text-xl sm:text-2xl font-black uppercase tracking-[0.3em] opacity-0 animate-[fadeInSlide_0.8s_ease-out_forwards]
        ${theme === "Dark" ? "text-white" : "text-gray-900"}`}>
                      No Room Yet
                    </h1>

                    <div className={`h-[2px] w-0 mx-auto my-3 bg-blue-500 animate-[growLine_1s_ease-in-out_0.5s_forwards]`}></div>

                    <p className={`text-sm font-medium tracking-wide opacity-0 animate-[fadeInSlide_0.8s_ease-out_0.8s_forwards]
        ${theme === "Dark" ? "text-blue-200/60" : "text-blue-800/60"}`}>
